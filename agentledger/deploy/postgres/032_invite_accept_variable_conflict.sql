-- ============================================================
-- 032 — invite_accept: fix ON CONFLICT ambiguity (follow-up to 031)
-- ============================================================
-- Pilot applied 031 before #variable_conflict use_column was added.
-- Re-replace invite_accept with the corrected body. Idempotent.
