...
export class ConnectorsController {
  ...
  @Roles('viewer')
  @Get(':id/attribution-mappings')
  listAttributionMappings(@Param('id') id: string) {
    return this.attributionMappings.list(id);
  }

  @Roles('admin')
  @Post(':id/attribution-mappings')
  async createAttributionMapping(
    @Param('id') id: string,
    @Body() dto: CreateAttributionMappingDto,
  ) {
  ...
  @Roles('admin')
  @Delete('attribution-mappings/:mappingId')
